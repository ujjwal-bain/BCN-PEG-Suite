...
import { Building2, BarChart3, Brain, Heart, Monitor, Users, TrendingUp, Shield, Cog, Target, TabletSmartphone, Leaf, CircleDollarSign, Microscope, ShoppingBag, Cpu, Wrench, Boxes, Banknote, CreditCard, Wallet, LineChart, ShieldCheck, Activity, BarChart4, Star, UserSearch, ChartNoAxesColumn, ChartNoAxesCombined, ChartColumn, ChartPie } from "lucide-react"
...
const bubbleTiles: BubbleTile[] = [
    ...
    },
    {
        ...
        path: "/peg-tools/#other-peg-tools",
    },
    {
        id: "pe-pulse-tool",
        name: "PE Pulse tool",
                                    ...
                                    >
                                        ...
                                        {tile.imageSrc && (
                                            <img
                                                src={tile.imageSrc}
                                                alt={tile.name}
                                                className={`mb-2 mt-4 ${tile.heightPercent >= 40 ? "h-8 w-8" : tile.heightPercent >= 30 ? "h-6 w-6" : "h-5 w-5"} object-contain`}
                                            />
                                        )}
                                        <h3
